...
const prisma_feedback_respository_1 = require("./repositories/prisma/prisma-feedback-respository");
...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const prismaFeedbacksRepository = new prisma_feedback_respository_1.PrismaFeedbacksRepository();
    const nodemailerMailAdapter = new nodemailer_mail_adapter_1.NodemailerAdapter();
